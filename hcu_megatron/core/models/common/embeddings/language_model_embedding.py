...
from megatron.core.models.common.embeddings.language_model_embedding import LanguageModelEmbedding as MegatronCoreLanguageModelEmbedding

from hcu_megatron.core.tensor_parallel.vocab_input_store import VocabInputStore
from hcu_megatron.core.tensor_parallel import VocabParallelInput
...
class LanguageModelEmbedding():
    ...
    def __init__(
        ...
        super(MegatronCoreLanguageModelEmbedding, self).__init__(config=config)
        ...
        if self.vocab_embedding_only:
            self.word_embeddings = VocabParallelInput(
