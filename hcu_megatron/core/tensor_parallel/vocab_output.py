...
class _ForwardImpl(torch.autograd.Function):
    ...
    def forward(
        ...
        if fuse_forward_input_grad:
            ...
            if not sequence_parallel:
                ...
                sub_softmax_grad_input_handle = dist_reduce_scatter_func(
                ...
                sub_ground_truth_grad_input_handle = dist_reduce_scatter_func(
    ...
    def backward(ctx, grad_output, *_):
        ...
        grad_output = grad_input.to(weight.dtype)
