...
from hcu_megatron.primus.backends.transformer_engine.pytorch.common.triton.permutation import (
...
def permute_with_mask_map(
    ...
    permuted_probs = alloc((num_out_tokens,), dtype=probs.dtype, device="cuda") if probs is not None else None
    permuted_scale = (
