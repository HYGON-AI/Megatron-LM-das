...
class RecomputeActivationFeature(AbstractFeature):
    ...
    def register_patches(self, patch_manager, args):
        from hcu_megatron.core.memory.recompute.activation.adaptor import hcu_activation_recompute_forward
        from hcu_megatron.core.transformer.transformer_layer import transformer_layer_init_wrapper
        ...
        if getattr(args, self.feature_name, None):
            ...
            patch_manager.register_patch('megatron.core.transformer.mlp.MLP.forward', hcu_activation_recompute_forward)
