...
from .vision_config import Qwen2VLTransformerConfig
...
class Qwen2_5VLModel(MegatronModule):
    ...
    def freeze(
        ...
        if torch.distributed.get_rank() == 0:
            print(f"freeze_language_model:{freeze_language_model}")
            print(f"freeze_vision_model:{freeze_vision_model}")
            print(f"freeze_vision_projection:{freeze_vision_projection}")
        modules = []
