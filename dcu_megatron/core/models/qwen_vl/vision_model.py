...
from .vision_block import TransformerBlock
...
class Qwen2_5VisionModel(VisionModule):
    ...
    def __init__(
        ...
        # Transformer layers.
        # TD: Follow-up changes will make pre and post_process configurable. They are needed for supporting pipeline parallelism.
    ...
    def forward(
        ...
        seq_len, hidden_dim = vision_data.size()
        ...
        rotary_pos_emb = rotary_pos_emb[window_index, :, :]  # 按窗口选择
        rotary_pos_emb = rotary_pos_emb.reshape(seq_len, 1, 1, -1).repeat(1, 1, 1, 2)  # decoder 需要的形状
