...
def _build_key_size_numel_dictionaries(keys, data):
    ...
    torch.distributed.broadcast(
        sizes_cuda, parallel_state.get_tensor_model_parallel_src_rank(), group=parallel_state.get_tensor_model_parallel_group()
    )
...
def broadcast_data(keys, data, datatype):
    ...
    # Broadcast
    torch.distributed.broadcast(
        flatten_data, parallel_state.get_tensor_model_parallel_src_rank(), group=parallel_state.get_tensor_model_parallel_group()
    )
