...
from dcu_megatron.core.datasets.mega_indexed_jsonl_dataset_v3 import MegaIndexedJsonlDatasetMM
try:
    from dcu_megatron.core.datasets.tools.lmdb_read_cli import fetch_images_from_lmdb
except ImportError:
