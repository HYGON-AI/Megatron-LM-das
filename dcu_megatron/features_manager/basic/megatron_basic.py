...
class MegatronBasicFeature(AbstractFeature):
    ...
    def register_core_dist_checkpointing_patches(self, patch_manager, args):
        if args.use_ckpt_memory_cache:
            from dcu_megatron.core.dist_checkpoint.strategies.filesystem_async import FileSystemWriterAsync
            from dcu_megatron.core.dist_checkpoint.strategies.torch import TorchDistLoadShardedStrategy

            from dcu_megatron.core.dist_checkpoint.validation import _compute_shards_access
            from dcu_megatron.core.dist_checkpoint.strategies.fully_parallel import FullyParallelLoadStrategyWrapper
            from dcu_megatron.core.dist_checkpoint.exchange_utils import determine_main_replica_uniform_distribution
    ...
    def register_core_models_patches(self, patch_manager, args):
        ...
        from dcu_megatron.core.models.common.embeddings.language_model_embedding import LanguageModelEmbedding
    ...
    def register_core_transformers_patches(self, patch_manager, args):
        ...
        from dcu_megatron.core.transformer.multi_latent_attention import multi_latent_attention_forward_wrapper
        from dcu_megatron.core.transformer.multi_token_prediction import MultiTokenPredictionLayer
    ...
    def register_core_tokenizers_patches(self, patch_manager, args):
        from dcu_megatron.core.tokenizers.utils.build_tokenizer import build_tokenizer_wrapper
    ...
    def register_core_extentions_patches(self, patch_manager, args):
        ...
        from dcu_megatron.core.extensions.transformer_engine import get_cpu_offload_context
    ...
    def register_tensor_parallel_patches(self, patch_manager, args):
        from dcu_megatron.core.parallel_state import log_timing_wrapper
        from dcu_megatron.core.tensor_parallel.random import checkpoint_wrapper
    ...
    def register_pipeline_parallel_patches(self, patch_manager, args):
        from dcu_megatron.core.pipeline_parallel.utils import set_ideal_affinity_for_current_gpu
    ...
    def register_training_patches(self, patch_manager, args):
        from dcu_megatron.training.training import train
        from dcu_megatron.training.initialize import _set_random_seed
        from dcu_megatron.training.training import train_step
        ...
        from dcu_megatron.training.arguments import core_transformer_config_from_args_wrapper
    ...
    def register_miscellaneous_patches(self, patch_manager, args):
        from dcu_megatron.training.arguments import validate_args_func_decorator, _print_args
        from dcu_megatron.core.parallel_state import create_group, initialize_model_parallel_wrapper
        from dcu_megatron.miscellaneous.gpt_builders import gpt_builder_wrapper
    ...
    def register_legacy_models_patches(self, patch_manager, args):
        from dcu_megatron.legacy.model.transformer import (
        ...
        from dcu_megatron.legacy.model.utils import get_norm
        from dcu_megatron.legacy.model.language_model import TransformerLanguageModel
        from dcu_megatron.legacy.model.gpt_model import GPTModel
