...
def get_batch(data_iterator, vp_stage: Optional[int] = None, microbatch_id=None):
    ...
    if not args.enable_vocab_parallel and not is_first_or_last_pipeline_stage(vp_stage) and not is_packed_sequence and (
    ...
    if not args.enable_vocab_parallel and not is_first_or_last_pipeline_stage(vp_stage) and is_packed_sequence:
