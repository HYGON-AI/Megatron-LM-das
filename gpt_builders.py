...
def gpt_builder(args, pre_process, post_process, vp_stage=None, config=None, pg_collection=None,
    ...
    # Optimize the GPU memory of the first stage
    is_zbh1_or_1f1b_delay_wgrad_compute = args.schedule_method == "zb_h1" or (
        args.schedule_method == "vanilla" and args.delay_1f1b_cooldown_wgrad_compute)
    if is_zbh1_or_1f1b_delay_wgrad_compute and is_pp_first_stage(parallel_state.get_pipeline_model_parallel_group()):
