...
DATA_PATH=""                                                             # path to vlm/gpt data config
TOKENIZER_MODEL_PATH=""                                                  # HuggingFace path to model
LAUNCHER="mpirun"                                                        # mpirun or torchrun
CHECKPOINT_PATH=""                                                       # path to ckpt
TRAIN_SCRIPT=${TRAIN_SCRIPT:-train_gemma3vl_12B.sh}                      # script under this example directory to run
