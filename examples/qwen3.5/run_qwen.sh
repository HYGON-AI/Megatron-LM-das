...
DATA_PATH=""                                                             # Data file path (e.g., oscar-1GB_head-llama2_text_document, sft.json, or vlm-config.json)
TOKENIZER_MODEL_PATH=""                                                  # HuggingFace path to model. example Qwen/Qwen3.5-9B
LAUNCHER="mpirun"                                                        # mpirun or torchrun
CHECKPOINT_PATH=""                                                       # path to ckpt
TRAIN_SCRIPT=${TRAIN_SCRIPT:-train_qwen35_9B.sh}                         # script under this example directory to run
